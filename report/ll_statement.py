...
class LLStatementReport(models.AbstractModel):
    _name = "report.account_financial_report.ll_statement"
    _description = "LL Statement Report"
    ...
    def _get_report_values(self, docids, data):
        ...
        ll_statement = self._create_ll_statement(
            gen_ld_data,
            accounts_data,
            grouped_by,
            rec_after_date_to_ids,
        ...
        return {
            "doc_ids": [wizard_id],
            "doc_model": "ll.statement.report.wizard",
            "docs": self.env["ll.statement.report.wizard"].browse(wizard_id),
            "foreign_currency": data["foreign_currency"],
