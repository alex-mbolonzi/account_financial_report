...
class LLStatementXslx(models.AbstractModel):
    _name = "report.a_f_r.report_ll_statement_xlsx"
    _description = "LL Statement XLSX Report"
    _inherit = "report.account_financial_report.abstract_report_xlsx"

    def _get_report_name(self, report, data=False):
        company_id = data.get("company_id", False)
        report_name = _("LL Statement")
        if company_id:
    ...
    def _generate_report_content(self, workbook, report, data, report_data):
        res_data = self.env[
            "report.account_financial_report.ll_statement"
        ]._get_report_values(report, data)
        ll_statement = res_data["ll_statement"]
    ...
    def write_initial_balance_from_dict(self, my_object, report_data):
        """Specific function to write initial balance for LL Statement"""
        label = False
    ...
    def write_ending_balance_from_dict(self, my_object, report_data):
        """Specific function to write ending balance for LL Statement"""
        label = name = False
