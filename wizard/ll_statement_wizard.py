...
class LLStatementReportWizard(models.TransientModel):
    """LL Statement report wizard."""

    _name = "ll.statement.report.wizard"
    _description = "LL Statement Report Wizard"
    ...
    def _print_report(self, report_type):
        self.ensure_one()
        data = self._prepare_report_ll_statement()
        if report_type == "xlsx":
            report_name = "a_f_r.report_ll_statement_xlsx"
        else:
            report_name = "account_financial_report.ll_statement"
        return (
    ...
    def _prepare_report_ll_statement(self):
        self.ensure_one()
        return {
            "wizard_id": self.id,
